package com.hexagraph.jagrati_android.model.facedata
...
@Serializable
data class StudentWithFaceDataListResponse(
    val students: List<StudentWithFaceDataResponse>
)

@Serializable
data class VolunteerWithFaceDataListResponse(
    val volunteers: List<VolunteerWithFaceDataResponse>
)
